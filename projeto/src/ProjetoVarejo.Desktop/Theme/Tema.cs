...
/// <summary>
/// Sistema de design central inspirado em Totvs/Bling/Conta Azul.
/// Paleta sóbria, tipografia consistente, métricas padronizadas.
/// </summary>
public static class Tema
{
    // === Paleta principal ===
    // Azul mais sóbrio (similar Conta Azul / Totvs Fluig)
    ...
    // === Cores semânticas (mais flat, menos vivas) ===
    ...
    // === Neutros (escala de cinza moderna) ===
    ...
    // === Sidebar (azul muito escuro, quase preto) ===
    ...
    public static Color SidebarSecao = Color.FromArgb(120, 135, 160);  // label de seção

...
public class FrmFornecedores : Form
{
    ...
    private void InitUi()
    {
        ...
        lblTotal = (Label)header.Controls[0];
        ...
        var pnlBotoes = new FlowLayoutPanel { Dock = DockStyle.Right, Width = 400, FlowDirection = FlowDirection.RightToLeft, BackColor = Tema.CorFundo };
        var btnNovo = Botoes.Primario("Novo fornecedor", 190, 40);

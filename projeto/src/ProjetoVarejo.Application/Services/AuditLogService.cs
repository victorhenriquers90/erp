...
public class AuditLogService
{
    ...
    {
        await RegistrarComUsuarioAsync(_sessao.UsuarioLogado?.Id, entidade, registroId, tipo, antes, depois);
    }

    public async Task RegistrarComUsuarioAsync(int? usuarioId, string entidade, string registroId, TipoAuditoria tipo, string? antes = null, string? depois = null)
    {
